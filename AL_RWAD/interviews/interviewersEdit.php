              ...
              <div class="card">
                <div class="card-header">
                  <div class="d-flex align-items-center">
                    <div class="card-title animate__animated animate__bounce"> تعديل مقابل </div>
                  </div>
                </div>
                <?php
                ...
                $result = staticDB::selectFromTableWhere("al_rwwad", "interviewers", ["Interviewers_id", "name", "phone", "address"], "Interviewers_id", "=", $id);
                        ...
                        <div class="container mt-5">
                          <form method="post">
                            <div class="mb-3">
                              ...
                              <input type="text" class="form-control" id="name" name="interviewers_name" value="<?php echo $row['name']; ?>">
                            </div>
                            <div class="mb-3">
                            ...
                            <input type="hidden" name="Intr_id" value="<?= $id ?>">
                            <button name="update_inter" style="width: 100%" type="submit" class="btn btn-success">حفظ</button>
                          </form>
                        </div>
                    </div>
                  </div>
