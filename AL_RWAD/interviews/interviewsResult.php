              ...
              <div class="card">
                <div class="card-header">
                  <div class="d-flex align-items-center">
                    <div class="card-title animate__animated animate__bounce">تفاصيل المقابلة </div>
                  </div>
                </div>
                <div class="card-body">
                  <?php
                  ...
                  interviewers.name AS int_name,
                   applicants.name AS app_name ,
                    applicants.applicant_id AS app_id ,
                    
                     interviews.dateInterview	 AS int_date,
                     interviews.character	AS int_char,
                     interviews.Behavior	as int_Behavior,
                     interviews.Interviews_rate		as int_rate	,
                     	interviews.Interviews_state as views_state
                      

                      FROM interviews  JOIN applicants ON interviews.applicant_id = applicants.applicant_id JOIN interviewers ON interviews.Interviewers_id = interviewers.Interviewers_id		");
     ...
     applicants.name AS app_name ,
      applicants.applicant_id AS app_id ,
       ...
       interviews.Interviews_rate		as int_rate	,
         interviews.Interviews_state as views_state
        FROM interviews 
         JOIN applicants ON interviews.applicant_id = applicants.applicant_id
          JOIN interviewers ON interviews.Interviewers_id = interviewers.Interviewers_id");
      ...
      applicants.applicant_id AS app_id ,
       ...
       interviews.Interviews_rate		as int_rate	,
        ...
        FROM interviews 
         JOIN applicants ON interviews.applicant_id = applicants.applicant_id
          JOIN interviewers ON interviews.Interviewers_id = interviewers.Interviewers_id 
          WHERE interviews.Interviews_state='مقبول'");
            ...
            applicants.applicant_id AS app_id ,
             ...
             interviews.Interviews_rate		as int_rate	,
              ...
              FROM interviews 
               JOIN applicants ON interviews.applicant_id = applicants.applicant_id
                JOIN interviewers ON interviews.Interviewers_id = interviewers.Interviewers_id 
                WHERE interviews.Interviews_state='غيرمقبول'");
                    ...
                    applicants.applicant_id AS app_id ,
                     ...
                     interviews.Interviews_rate		as int_rate	,
                      ...
                      FROM interviews 
                       JOIN applicants ON interviews.applicant_id = applicants.applicant_id
                        JOIN interviewers ON interviews.Interviewers_id = interviewers.Interviewers_id 
                        WHERE interviews.Interviews_state=''");
                    }
                  }
                  ...
                  if (isset($_POST["passchek"])) {
                    ...
                    foreach ($chekArray as $onechecid) {
                      $page = staticDB::insert("al_rwwad", "interviews", ["applicant_id", "Interviewers_id"], [$onechecid, $Interviewers_id]);
                    }
                  }
                  ?>
                    ...
                    <table
                      ...
                      <tbody>
                        ...
                        while ($row = $result->fetch_assoc()) {
                          // $colorRow=getcolor($row['views_state']);
                          $badgecolor = badgecolor($row['views_state']);
                        ?>
                          <tr>
                            <td> <?php echo $row['app_name']; ?>
                            </td>
                            <td> <?php echo $row['int_date']; ?> </td>
                            <td> <?php echo $row['int_char']; ?> </td>
                            <td> <?php echo $row['int_Behavior']; ?> </td>
                            <td> <?php echo $row['int_rate']; ?>
                              <span class="badge <?php echo $badgecolor ?>">
                                <?php if (isset($row['views_state'])) {
                                  echo $row['views_state'];
                                } else {
                                  echo  "غير محدد";
                                }  ?></span>
                            </td>
